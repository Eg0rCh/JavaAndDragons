public class BattleScene {
    ...
    public void fight(Entity hero, Entity monster, Realm.FightCallback fightCallback) {
    ...
    private Boolean makeHit(Entity defender, Entity attacker, Realm.FightCallback fightCallback) {
        //Получаем силу удара
